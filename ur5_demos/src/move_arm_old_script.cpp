...
void ur5Behavior::action_position_top()
{
	...
	// open_gripper();
	std::map<std::string, double> target;
	target["shoulder_pan_joint"] =  -0.71994832;
	target["shoulder_lift_joint"] =  -0.81454516;
	target["elbow_joint"] =  2.23663944;
	target["wrist_1_joint"] = 3.84775287;
	target["wrist_2_joint"] = -4.09873122;
	target["wrist_3_joint"] = -3.8049923;
...
void ur5Behavior::action_position_down()
{
	...
	// open_gripper();
	std::map<std::string, double> target;
	target["shoulder_pan_joint"] =  -0.83095126;
	target["shoulder_lift_joint"] =  -0.9265953;
	target["elbow_joint"] =  2.19544967;
	target["wrist_1_joint"] = 4.11356651;
	target["wrist_2_joint"] = -4.20589443;
	target["wrist_3_joint"] = -3.63115751;
...
void ur5Behavior::stirringMotion_1()
{
	...
	joint_angles[0] = -0.83095126;
	joint_angles[1] = -0.9265953;
	joint_angles[2] = 2.19544967;
	joint_angles[3] = 4.11356651;
	joint_angles[4] = -4.20589443;
	joint_angles[5] = -3.63115751;
...
void ur5Behavior::stirringMotion_4() //dippping stirring behavior.
{
	// ROS_INFO("Attach the end effector.");
	// getch();
	// close_gripper();
